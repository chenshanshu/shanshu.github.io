! function (t) {
    ...
    var k = function (t) {
        ...
        return r(e, t), Object.defineProperty(e.prototype, "blocks", {
            ...
            for (var e in s.
                default.textures) this.load.addFile(new c.default(this.load, e, s.default.textures[e], {
                scale: t
            }))
            ...
            if (this.cat.anims.isPlaying && this.cat.anims.stop(), this.state !== i.PLAYING) return this.setStatusText(f.default("游戏已经结束，重新开局")), document.getElementById("time").innerHTML = 0, this.reset(), !1;
